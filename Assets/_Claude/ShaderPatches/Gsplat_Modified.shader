...
// Modified: Added _HueShift, _TintColor, _OpacityMul for animation support
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                // Apply hue shift (only if non-zero to save ALU)
                ...
                // Apply tint color (default white = no effect)
